		...
		<div class="container">
			<div class="row">
				<div class="col-md-7 col-md-5">
					<a href="<?php echo home_url( '/' ); ?>"><img class="e-claro img-responsive" src="<?php echo dirname( get_bloginfo('stylesheet_url'))."/images/header-logo.png"; ?>"/></a>
				</div>
				<div class="col-md-5">
					<div class="row">
						<ul class="menu-top">
					...
					<div class="row">
						<div class="col-md-12 text-right tel-top">
							11 1234-5678
						</div>
					</div>
					<div class="row">
